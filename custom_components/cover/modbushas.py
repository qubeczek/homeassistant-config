"""
ModbuSHAS platform for the cover component.
...
CONF_DEVICEADRESS = "deviceadress"
CONF_COVERS = "covers"

PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    vol.Required(CONF_COVERS): [{
        vol.Required(CONF_NAME): cv.string,
        vol.Required(CONF_DEVICEADRESS): cv.positive_int
    }]
})
...
class ModbusHASCover(CoverDevice):
    ...
    def __init__(self, hass, name, deviceadress):
        """Initialize the cover."""
        self.hass = hass
        self._name = name
        self._deviceadress = deviceadress
        self._position = 0
